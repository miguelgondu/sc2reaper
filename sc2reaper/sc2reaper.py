        ...
        with run_config.start() as controller:
            for replay_file in replay_files:
                try:
                    ...
                    # Which exceptions should we be catching here?
                    # Add tracking of conflicting replays.
                    print(f"Couldn't process replay {replay_file}")
                    pass
    except:
        # Add more verbosity, I guess.
        # Add tracking.
        print(f"Crashed on replay {last_replay_processed}.")
